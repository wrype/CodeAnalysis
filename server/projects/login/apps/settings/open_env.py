...
DEFAULT_PUBKEY = os.environ.get("AUTHORIZATION_PUBKEY", DEFAULT_PUBKEY)

DEFAULT_PRIVATEKEY = """-----BEGIN RSA PRIVATE KEY-----
...
DEFAULT_PRIVATEKEY = os.environ.get("AUTHORIZATION_PRIKEY", DEFAULT_PRIVATEKEY)
...
SIMPLE_JWT = {
    ...
    "ALGORITHM": "RS256",
    "VERIFYING_KEY": DEFAULT_PUBKEY,
    "SIGNING_KEY": DEFAULT_PRIVATEKEY,
